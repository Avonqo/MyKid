...
public class ViewProfileActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final DatabaseReference myref = FirebaseDatabase.getInstance().getReference().child("Learners");
        ...
        demodef.addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(DataSnapshot dataSnapshot, String s) {
               // fetch(dataSnapshot);
                ...
                LearnersAdapter learnersAdapter = new LearnersAdapter(ViewProfileActivity.this,learnersList);
